...
defmodule OpenFGA.Connection do
  @moduledoc """
  Handle Tesla connections for OpenFGA.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, OpenFGA.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:open_fga, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - OpenFGA 0.0.1 - elixir"
        )
      )
